...
\begin{table}[H]
	\begin{tabular}{|l|c|c|c|c|}
		...
		\textbf{\begin{tabular}[c]{@{}l@{}}Compatibel met\\ (AR frameworks):\end{tabular}} & ARKit         & \begin{tabular}[c]{@{}c@{}}Unity3D, Unreal \\ Engine,\\ ARKit, ARCore\end{tabular} & \begin{tabular}[c]{@{}c@{}}Unity3D, maar\\ Vuforia is een\\ AR-SDK op \\ zichzelf\end{tabular}                              & \begin{tabular}[c]{@{}c@{}}Unity3D, Unreal \\ Engine,\\ ARKit, ARCore\end{tabular}    \\ \hline
		\textbf{Documentatie}                                                              & Ja            & Ja                                                                                 & Ja                                                                                                                          & Ja                                                                                    \\ \hline
	\end{tabular}
