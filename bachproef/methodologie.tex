...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{Boxplots_Boek.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{Boxplots_Persoon.png}
	\caption{Boxplots test persoon}
\end{figure}
\subsection{Test met fles}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{Boxplots_Fles.png}
	\caption{Boxplots test fles}
\end{figure}
\subsection{Test met horloge}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.35]{Boxplots_Horloge.png}
